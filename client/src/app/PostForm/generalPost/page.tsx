    ...
    return (
        ...
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base font-semibold leading-7 text-gray-900">Post a Dive</h2>
            <p className="mt-1 text-sm leading-6 text-gray-600">
              Share a dive you completed with other users. 
            </p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                ...
                <p className="mt-3 text-sm leading-6 text-gray-600">Write a few sentences about the dive.</p>
              </div>
          ...
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base font-semibold leading-7 text-gray-900">Dive Information</h2>
          ...
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base font-semibold leading-7 text-gray-900">Marine Life</h2>
            <p className="mt-1 text-sm leading-6 text-gray-600">
